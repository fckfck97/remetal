...
from .reportes import imprimir_factura_recibo,imprimir_factura_list,imprimir_reporte_cliente
...
urlpatterns = [
    ...
    path('clientes/imprimir/<int:id>',imprimir_reporte_cliente, name="imprimir_reporte_cliente"),
